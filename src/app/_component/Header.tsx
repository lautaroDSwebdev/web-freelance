    ...
    <div className="g-bg-dark  section-entireheight  p-[3rem_1rem] h-[92dvh]" id="home">
      <section className="flex flex-col sm:flex-row gap-[21rem] sm:gap-[0rem] lg:gap-[8rem] justify-center max-width m-auto sm:h-[30rem]">
        <article className="h-[10vh]">
          ...
          <p className="p-[1rem]  text-center sm:text-left text-[14px] sm:text-[2.3vw] md:text-[16px]">
        ...
        <article className="relative mx-auto ">
          <img
            className="h-auto w-[11rem]   sm:w-[16rem] lg:w-[21rem] max-w-[21rem]"
            src="./mi-cara.png"
            alt="imagen mia"
          />
          <div className="absolute    sm:top-[15rem] lg:top-[18rem] flex flex-col sm:flex-row gap-[1rem] sm:gap-[1rem]">
